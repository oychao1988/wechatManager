...
# 来自自己的指令
cmdsLv4       = ['tips']
cmdsLv3       = ['addReply', 'delReply', 'autoReplyOn', 'autoReplyOff',
                 'fileHelperOn', 'fileHelperOff',
                 'mfRatio', 'signatureCloud','geoData', 'checkFriendStatus',
                 'getChatrooms', 'getChatroomMembers',
                 'getFriends', 'updateFriendList', 'updateChatroomList',
                 'friendInChatrooms', 'addTimerTask',
                ]
cmdsLv2       = []
