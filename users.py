...
from storage import MysqlHelper
import config
from config import connectionDict
from log import logging
from plugins import SchemeTimerThead
...
class User(object):
    def __init__(self, nickName):
        ...
        self.mysqlHelper     = MysqlHelper(connectionDict)
        self.MysqlInspect()
...
def MysqlInspect(self):
    ...
    if table_name in [each['Tables_in_wechat'] for each in result]:
        ...
        self.mysqlHelper.insertOne(table_name, nickName='欧阳超', userType=0)
